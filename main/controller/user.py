...
class UserSignup(Resource):
    ...
    @user_ns.response(0, "success", UserDto.user_UserSignup_model_response)
    def post(self):
        # try:
...
class Forgetpassword(Resource):
    ...
    @user_ns.response(0, "success", UserDto.user_Forgetpassword_model_response)
    # @token_required
    def post(self):
        # try:
...
class ChangPassword(Resource):
    ...
    @user_ns.response(0, "success", UserDto.user_ChangPassword_model_response)
    @token_required
    def put(self):
        try:
